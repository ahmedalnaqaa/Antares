...
ActiveRecord::Schema.define(version: 20200111030516) do
  ...
  create_table 'admin_users_pages_joins', id: false, force: :cascade, options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8' do |t|
    t.integer 'admin_user_id'
    t.integer 'page_id'
  end
